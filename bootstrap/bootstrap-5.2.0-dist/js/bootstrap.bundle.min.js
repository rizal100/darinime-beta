...
!(function (t, e) {
  ...
  function Me(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (('body' !== Wt(e) || we(a)) && (c = (n = e) !== Bt(n) && zt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : ve(n)), zt(e) ? (((h = Yt(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = ye(a))),
  ...
  class an extends z {
    ...
    _getTemplateFactory(t) {
      return this._templateFactory ? this._templateFactory.changeContent(t) : (this._templateFactory = new Yi({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
    }
